...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'nhipsterapp';
    ...
    'jhipster.mail.from' = 'nhipsterapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nhipsterapp API';
    'jhipster.swagger.description' = 'nhipsterapp API documentation';
    ...
    'eureka.instance.appname' = 'nhipsterapp';
    'eureka.instance.instanceId' = 'nhipsterapp:${random.value}';
